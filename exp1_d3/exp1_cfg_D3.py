...
cfg.exp1 = {
    'targetPhase': 'D3test',
    'weightPeriod': 'Before D3 test',  # Weight loading period for D3test
    'activityTimepoint': 'D3 test 4k'  # Activity data timepoint
}


#------------------------------------------------------------------------------
# STIMULATION CONFIGURATION - Fixed maximum weight
#------------------------------------------------------------------------------
# Set fixed_max stimulation weight
cfg.stimWeight = 15.0  # Fixed maximum weight for stimulation
...
# Calculate total duration for the D3test phase based on concurrent blocks
phase_duration_ms = num_concurrent_blocks * full_trial_cycle_ms

# Set timing for D3test only
